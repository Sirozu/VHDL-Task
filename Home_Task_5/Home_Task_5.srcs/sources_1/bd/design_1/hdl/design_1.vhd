...
entity design_1 is
  ...
  attribute CORE_GENERATION_INFO of design_1 : entity is "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,synth_mode=Global}";
...
architecture STRUCTURE of design_1 is
  ...
  component design_1_Shift_Reg_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component design_1_Shift_Reg_0_0;
  signal CLK_1 : STD_LOGIC;
  signal RST_1 : STD_LOGIC;
  signal Shift_Reg_0_Valid_out : STD_LOGIC;
  signal Shift_Reg_0_storeBits : STD_LOGIC_VECTOR ( 31 downto 0 );
...
begin
  ...
  Valid_out <= Shift_Reg_0_Valid_out;
  storeBits(31 downto 0) <= Shift_Reg_0_storeBits(31 downto 0);
Shift_Reg_0: component design_1_Shift_Reg_0_0
     port map (
      Q(7 downto 0) => UART_0_DOUT(7 downto 0),
      RST => RST_1,
      Valid_out => Shift_Reg_0_Valid_out,
      ce => UART_0_DOUT_VLD,
      clk => CLK_1,
